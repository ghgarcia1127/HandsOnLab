...
using HandsOnLab.Domain.Repository;
...
namespace HandsOnLab
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<HourlyEmployeeFactory>().Keyed<IEmployeeFactory>(EmployeeType.HourlySalaryEmployee);
            builder.RegisterType<MontlyEmployeeFactory>().Keyed<IEmployeeFactory>(EmployeeType.MonthlySalaryEmployee);
